            ...
            <div className="md:grid h-full md:grid-cols-12">
                <div className="col-span-6 flex justify-center items-center">
                    <div className="border-[1px] p-2 rounded ">
                        ...
                        <input onChange={(e) => setFirstName(e.target.value)} className="w-full p-1 border-[1px] border-black rounded  my-1" type="text" placeholder="enter first name" />
                        <Aster value="last Name" />
                        <input onChange={(e) => setLastName(e.target.value)} className="w-full p-1 border-[1px] border-black rounded  my-1" type="text" placeholder="enter last name" />
